    ...
    namespace ButlerSDK.ToolSupport
{
    ...
    public class ToolResolver
    {
        ...
        /// <remarks>If this class can't be converted to interface <see cref="IButlerToolResolver"/> it throws exception on create</remarks>
        public static IButlerToolResolver CreateSchedule(string name)
        {
        ...
        public async Task RunScheduleAsyncDoNow(IButlerToolBench ToolDB)
        {
