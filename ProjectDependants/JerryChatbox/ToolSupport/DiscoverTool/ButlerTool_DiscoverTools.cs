...
";
    ...
    internal enum DiscoverModes
        ...
        public override ButlerChatToolResultMessage? ResolveMyTool(string? FunctionCallArguments, string? FuncId, ButlerChatToolCallMessage? Call)
        {
            ...
            {
#if DEBUG
                Debug.Write($"Hey for DiscoverTool, some code is trying to call {nameof(ResolveMyTool)} without setting target {nameof(ButlerBase)} yet. Call {nameof(AssignButler)} with target!");
#endif
                return null;
            }
