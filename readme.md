...
-- IMPORTANT Note:
The the file loader sandbox unit tests do create small files in your temporary folder for the Unit Tests. Text File and symbolic links to simulate a determined attacker trying to escape my loader sandbox.
For example. On my PC: C:\Users\[username]\AppData\Local\Temp\Sombra_APT_Zone_0d70d67bddaa4e3da5748235b5210afa. The unit tests were designed by amachine with my overside to try to find holes in my file loader tool.
